...
#### boolean containsAll(Collection<?> c)
    If the user does not provide a Collection of values, then the function throws a NullPointerException() exception.
...
#### boolean equals(Object o)
    If the user does not provide an Object to compare with, the function throws a NullPointerException() exception.
...
#### boolean remove(Object o)
    If the user fails to provide an Object, throws a NullPointerException() exception.
...
#### boolean removeAll(Collection<?> c)
    If the user fails to provide a Collection, throws a NullPointerException() exception.
...
#### boolean retainAll(Collection<?> c)
    Similar to removeAll(), if the user fails to provide a Collection, throws a NullPointerException() exception.
...
#### boolean add(E e)
    If no value is providedthen throws NullPointerException() exception.
...
#### boolean offerLast(E e)
    ...
    If a value IS provided, adds the provided value to the end of this Deque and returns true.
#### E peek()
    If the Deque is empty, throws an NoSuchElementException() exception.
...
#### E poll()
    If the Deque is empty, throws a NoSuchElementException() exception.
...
#### E pop()
    If this stack is empty, throws an EmptyStackException() exception.
    If not, removes the first value from the stack representing this Deque and return it.
#### void push(E e)
    If no value is provided, throws a NullPointerException() exception.
    If a value is provided, pushes it to the top of the stack (i.e., as the first element in this Deque).
#### E remove()
    If this stack is empty, throws a NoSuchElementException() exception.
...
#### boolean add(E e)
    If no value is provided, the function throws a NullPointerException() exception, mentioning that a value MUST be provided.
    If a value IS provided, accommodates that value to the end of this List.
#### void add(int index, E element)
    Similar to above, if no value is provided, the function throws a NullPointerException() exception.
...
#### boolean addAll(Collection<? extends E> c)
    If no Collection is provided, the function throws a NullPointerException() exception, mentioning that a Collection of values MUST be provided.
...
#### boolean contains(Object o)
    Throws a NullPointerException() exception if no value is provided.
...
#### boolean containsAll(Collection<?> c)
    Throws a NullPointerException() exception if no collection is provided.
...
#### boolean equals(Object o)
    Throws a NullPointerException() exception if no Object is provided.
    If the provided Object is the same as the Object created by the provided class, then returns true. Or else, returns false.
#### E get(int index)
    Throws an IndexOutOfBoundsException() exception if index is provided, but is out of bounds.
...
#### E set(int index, E element)
    Throws a NullPointerException() exception if no replacement value is provided.
    Throws an IndexOutOfBoundsException() exception if index is provided, but is out of bounds.
...
#### List<E> subList(int fromIndex, int toIndex)
    Throws an IndexOutOfBoundsException() exception if both or either of the provided indexes is out of bounds.
    Throws an IllegalArgumentException() exception if fromIndex is greater than toIndex.
...
#### <T> T[] toArray(T[] a)
    Throws a NullPointerException() exception if no array a is provided.
...
##### public void add(int index, E element)
    If no element is provided, throws a NullPointerException() exceptionwith an error message stating that an element is required.
    If an element is provided, but index is out of bounds, throws an IndexOutOfBoundsException() exception with an error message stating that the provided index was out of bounds, including the index in the error message.
...
##### public boolean addAll(Collection<? extends E> c)
    If no Collection is provided, throws a NullPointerException() exception with an error message stating that a Collection is required.
...
##### public boolean addAll(int index, Collection<? extends E> c)
    If no Collection is provided, throws a NullPointerException() exception with an error message stating that a Collection is required.
    If an index IS provided, but is out of bounds, throws an IndexOutOfBoundsException() exception with an error message stating that the provided index is out of bounds, INCLUDING the provided index.
...
##### public boolean contains(Object o)
    For starters, if no Object is provided by the user, throws a NullPointerException() exception.
...
##### public boolean containsAll(Collection<?> c)
    If no Collection is provided, throws a NullPointerException() exception.
...
##### public boolean equals(Object o)
    If no Object is provided, throws a NullPointerException() exception.
...
##### public int indexOf(Object o)
    If no Object is provided, it throws a NullPointerException() exception.
...
##### public int lastIndexOf(Object o)
    If no value is provided, it will throw a NullPointerException() exception.
...
##### public boolean removeAll(Collection<?> c)
    ...
    Functionality:
        If a Collection of values is not provided, then the function throws a NullPointerException() exception.
...
### Built-in Classes
#### Node<E> Class with Generic variable
    Functionality:
        This built-in class is used to create a new Node that holds the following three variables:
            Node<E> previous: 
                Keeps track of the previous element
            E data:
                Variable to record the data provided by the user
            Node<E> next:
                Keeps track of the next element
        In this, previous and next do a recursive call to the Node constructor where they will each have their own previous and next pointers.
...
#### public boolean add(E e)
    ...
    Functionality:
        If no value is provided, the function throws a NullPointerException() exception.
        Adds the Node created with the provided value of type 'E' to this Doubly Linked List by doing one of the following:
            1) If this Linked List is empty, sets both the head Node and the tail Node to equal this new Node.
            2) If not, then it attaches this new Node by doing the following:
                1) Link the current tail's next to this new Node.
                2) Link this new Node's previous reference to the current tail.
                3) Finally, reassign the tail node the be the new Node.
...
#### public void add(int index, E element)
    ...
    Functionality:
        ...
        If no exceptions are thrown, then the function creates a new Node with the provided element.
        After that, the function will create a separate Node that points to the head (first) Node.
        Then, it will navigate to point to the Node located one Node before the location at which this newly created Node must go.
        Once there, it will link the new Node's next pointer to point to the current Node's next pointer.
        Then, it will link the new Node's previous pointer to point to the current Node.
        But, the Node that the new Node's next is pointing to will also have a pointer to the previous Node.
        So, it will assign the next Node's previous Node pointer to this new Node.
...
#### public boolean addAll(Collection<? extends E> c)
    ...
    Returns:
        ...
        False otherwise.
    Functionality:
        If a collection is not provided, then the function throws a NullPointerException() exception.
        If a collection is provided, but contains no values, then the function immediately returns false.
...
#### public boolean addAll(int index, Collection<? extends E> c)
    ...
    Returns:
        ...
        False otherwise.
    Functionality:
        Adds values in the order returned by the Iterator of this Collection into this Linked List at the specified index by doing these steps:
            1) Assign a variable current to point to the head Node
            2) Using a for-loop, navigate to the Node pointing to index - 1.
